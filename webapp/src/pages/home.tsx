...
export const Home = (props: {state: appState}) =>
    <div className="pageContent about">
        ...
        <table className="outlineTable"><tbody>
            ...
            <tr><td className="smallMargins">
                <p>Liran is a software developer based in Brisbane. Liran specialises in cloud computing, functional programming, and has set up the deployment infrastructure for this site. <a href="https://liranpiade.com">Link</a></p>
            </td></tr>
        </tbody></table>
